...
class FaceEngine:
    """Cached InsightFace wrapper.

    The heavy FaceAnalysis model is loaded lazily and cached on this instance.
    Flask creates one FaceEngine and stores it in app.extensions, so requests
    reuse the same model instead of loading InsightFace repeatedly.
    """
