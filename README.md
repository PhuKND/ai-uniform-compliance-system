...
1. Clone Repository
```bash
git clone https://github.com/your-username/ai-uniform-compliance-system.git
cd ai-uniform-compliance-system
```
---
2. Backend Setup
```bash
...
git branch -M main
git remote add origin https://github.com/your-username/ai-uniform-compliance-system.git
